...
/**
 * @description: Check mcpwm group is available.1 is available,0 is no available.
 * @param {int} goup_id
 * @return {*}
 */
...
/**
 * @description: Check ledc channel is available.1 is available,0 is no available.
 * @param {vector<int>} ledc_channel
 * @return {*}
 */
...
/**
 * @description: Automatically finds available drivers. 0 is no available, 1 is mcpwm available, 2 is ledc available.
 * @return {*}
 */
...
/**
 * @description: Mark the mcpwm group_id is in use.
 * @param {int} goup_id
 * @return {*}
 */
...
/**
 * @description: mark the ledc channel is in use.
 * @param {vector<int>} ledc_channels
 * @return {*}
 */
...
/**
 * @description: ESP32 platform specific function. Auto init hardware.
 * @return {*}
 */
...
/**
 * @description: ESP32 platform specific function. Init hardware.
 * @param {driverMode} _driverMode
 * @return {*}
 */
...
/**
 * @description: ESP32 platform specific function. Write pwm duty.
 * @return {*}
 */
